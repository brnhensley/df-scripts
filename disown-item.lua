--[[
    ...
    It solves an already solved problem from version 42.04, this script is just for lua practice.
    The script was made follwing the instructions of gchristopher in the forums,
    I took those instructions and make it into an script to run with df hack
...
if unit ~= null and item ~= null then
    ...
    print("You have to select an inventory item in DF to use this script.")
end
